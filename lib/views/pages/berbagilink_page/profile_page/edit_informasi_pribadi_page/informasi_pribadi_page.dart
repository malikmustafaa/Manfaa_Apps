...
class InformasiPribadiPage extends StatefulWidget {
  const InformasiPribadiPage({Key? key}) : super(key: key);

  @override
  State<InformasiPribadiPage> createState() => _EditUserState();
}

class _EditUserState extends State<InformasiPribadiPage> {
  File? image;
  File? image1;
