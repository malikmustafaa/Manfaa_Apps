...
import 'package:manfaa_apps/views/widgets/table_daftar_akun_terhubung.dart';

class HubungkanAkunPage extends StatefulWidget {
  const HubungkanAkunPage({Key? key}) : super(key: key);

  @override
  State<HubungkanAkunPage> createState() => _HubungkanAkunState();
}

class _HubungkanAkunState extends State<HubungkanAkunPage> {
  bool isHidden = true;
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: const [
                      TableDaftarAkunTerhubungWidget(),
                    ],
                  ),
