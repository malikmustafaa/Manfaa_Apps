...
class TableDaftarAkunTerhubung extends StatefulWidget {
  const TableDaftarAkunTerhubung({Key? key}) : super(key: key);

  @override
  State<TableDaftarAkunTerhubung> createState() => _TableDaftarAkunState();
}
